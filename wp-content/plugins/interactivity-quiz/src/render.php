...
<div id="<?php echo esc_attr($unique_id); ?>" style="background-color: <?php echo $attributes['bgColor']; ?>;" class="paying-attention-frontend" data-wp-interactive="create-block" <?php echo wp_interactivity_data_wp_context($attributes); ?>>
    ...
    <ul>
        <template data-wp-each="context.answers">
            ...
            <li data-wp-on--click="actions.guessAttempt"
                data-wp-class--no-click="context.showCorrectMessage"
                data-wp-class--fade-incorrect="callbacks.showCrossIcon">
                <!-- Check icon for correct answer -->
                <span data-wp-bind--hidden="!callbacks.showCheckIcon">
                    <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" class="answer-icon check-icon" viewBox="0 0 16 16">
                        <path d="M10.97 4.97a.75.75 0 0 1 1.07 1.05l-3.99 4.99a.75.75 0 0 1-1.08.02L4.324 8.384a.75.75 0 1 1 1.06-1.06l2.094 2.093 3.473-4.425z" />
                    </svg>
                </span>

                <!-- Cross icon for incorrect answers -->
                <span data-wp-bind--hidden="!callbacks.showCrossIcon">
                    <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" class="answer-icon cross-icon" viewBox="0 0 16 16">
    ...
    <div class="correct-message" data-wp-class--correct-message--visible="context.showCorrectMessage">
    ...
    <div class="incorrect-message" data-wp-class--incorrect-message--visible="context.showIncorrectMessage">
